...
export const guardarPinGuiaTriggerSchema = Joi.object({
    ...
    nit_cliente: Joi.string().allow(null, '', 0).min(0).optional(),
    div_cliente: Joi.string().allow(null, '', 0).min(0).optional(),
